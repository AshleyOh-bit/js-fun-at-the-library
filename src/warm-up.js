...
// var ...
var title = "Where the Sidewalk Ends";
var pages = 120;
...
var sequel = "A Light in the Attic: a sequel to " + title;
...
if (pages < 1000) {
  console.log("I could read it in a day!")
} else {
...
var books =  ["Breaking Dawn", "The Bible", "In the Beginning...was the Command Line", "To All the Boys I've Loved Before", "My Year of Rest and Relaxation"];
...
var belowTwoHundred = [0, 3, 50, 76, 200, 99, 203, .3333, 60, 10, 24, 12];
